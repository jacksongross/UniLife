...
#ifndef __UniLife__SciMed_Foyer__
#define __UniLife__SciMed_Foyer__
...
class SciMedFoyer : public cocos2d::Layer
{
public:
...
#endif /* defined(__UniLife__SciMed_Foyer__) */

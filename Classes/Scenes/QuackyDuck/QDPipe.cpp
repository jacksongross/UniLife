...
void QDPipe::SpawnPipe(cocos2d::Layer *layer)
{
    CCLOG("SPAWN PIPE");
 
    auto topPipe = Sprite::create("QuackyDuck/Pipe2.png");
    auto bottomPipe = Sprite::create("QuackyDuck/Pipe2.png");
    
    auto topPipeBody = PhysicsBody::createBox(topPipe->getContentSize());
    auto bottomPipeBody = PhysicsBody::createBox(bottomPipe->getContentSize());
    
    //Gap isn't too high or too low
